...
Each instance of a 'Monad' should abide by the three MONADIC LAWS. These laws
...
lists, which we then flatten out into a single list using 'concat'. For
example:
